      ...
      <section className={styles.cityHero}>
        <div className={`ever-shell ${styles.cityHeroGrid}`}>
          <div>
            ...
            <h1>{city.name} electronic recycling, without the guesswork.</h1>
          </div>
      ...
      <section className={styles.cityBody}>
        <div className={`ever-shell ${styles.cityGrid}`}>
          <div className={styles.cityPrimary}>
            <h2>Electronic recycling in {city.name}.</h2>
            <p>
              Check individual electronics online, request residential pickup with a
              distance-based fee, or plan a commercial pickup. Commercial loads with at
              least 10 qualifying items may qualify for free pickup.
            </p>
